...
def extrair_texto_com_base(image_path, modelo, config='--psm 6'):
    """Extrai texto usando uma base específica do Tesseract"""
    try:
        # Carregar imagem
        ...
        texto = pytesseract.image_to_string(img_final, lang=modelo, config=config)
...
def testar_todas_bases():
    """Testa todas as bases do Tesseract"""
    ...
    print("🏎️ TESTANDO TODAS AS BASES DO TESSERACT")
    print("=" * 60)
    ...
    for modelo, descricao in bases:
        ...
        texto = extrair_texto_com_base(arquivo_teste, modelo)
